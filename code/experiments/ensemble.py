...
if condition == "Perception":
    #data = "../dataset_creation/ZERO-PADDED-PERCEPTION.h5" ###THIS GIVES CHANCE RESULTS
    data = "../dataset_creation/TRIMMED_PERCEPTION.h5" #same result as first dataset, can delete the first one bc this is clear that it's trimmed
    #data = "FEATURES_DATASET_PERCEPTION.h5"
    data = "../../../Thesis/PERCEPTION_DATASET_W_PREC_ICA.h5" #also good results, but different from trimmed one. best one little lower than other best one but average might be higher? what was different in this preprocessing(?)
    #data = "../../../Thesis/PERCEPTION_DATASET.h5" #definitely worse results but still something

    #stober's preprocessed data for comparison
    #data = "../../../Thesis/Thesis_Data/OpenMIIR-Perception-512Hz.hdf5" #XXX
...
"""
#XXX this was to do it on Stober's data
