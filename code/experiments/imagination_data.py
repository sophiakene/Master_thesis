...
data = "IMAGINATION_DATASET_W_PREC_ICA.h5"
...
with h5py.File(data, 'r') as f:
    ...
    print("5-FOLD CROSS-VALIDATION OF SONG PREDICTION USING THEIR PREPROCESSED DATA:")
    ...
    print("5-FOLD CROSS-VALIDATION OF METER PREDICTION USING MY PREPROCESSED DATA:")
    baseline_classifier = svm.SVC(kernel = "linear", C=0.0001)
    cv = StratifiedKFold(n_splits=5, shuffle=True, random_state=42)
    ...
    print("5-FOLD CROSS-VALIDATION OF LYRICS PREDICTION USING MY PREPROCESSED DATA:")
    baseline_classifier = svm.SVC(kernel = "linear", C=0.0001)
    cv = StratifiedKFold(n_splits=5, shuffle=True, random_state=42)
